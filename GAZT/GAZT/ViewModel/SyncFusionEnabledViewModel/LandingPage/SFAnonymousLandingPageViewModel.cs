...
namespace EGAZT.ViewModel.SyncFusionEnabledViewModel.SFAnonymousLandingPage_ViewModel
{
    ...
    public class SFAnonymousLandingPageViewModel : ViewModelBase
    {
        ...
        public void PopulateeServicesApplicableToTheTaxPayer()
        {
           ...
           // eServicesAvailableToTheTP.Add(new eServiceInfo { eServiceName = AppResources.ZRealEstateServiceTitle, BackgroundGradientStart = "#006450", BackgroundGradientEnd = "#CCE0DC", iConImagePath = "service_6.png" });
