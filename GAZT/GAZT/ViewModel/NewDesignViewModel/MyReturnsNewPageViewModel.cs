...
namespace EGAZT.ViewModel.NewDesignViewModel
{
    ...
    public class GAZTNewDesignMyReturnsNewPageViewModel : ViewModelBase
    {
        ...
        public async void OnPageLoad()
        {
            ...
            List<MyReturnsResult> ZakatReturns = new List<MyReturnsResult>();
            List<MyReturnsResult> ETReturns = new List<MyReturnsResult>();
            ...
            if (MyReturns != null && MyReturns.d != null && MyReturns.d.results.Count > 0)
            {
                ...
                if (ReturnsWHNonSubmitedChild.Count > 0)
                {
                    ...
                    //onSubmittedWHReturnsCount = AppResources.ZZWithholding + "(" + ReturnsWHNonSubmitedChild.Count + ")";
                }
                else
                {
