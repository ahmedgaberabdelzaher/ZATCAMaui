    ...
    public class OldZakatInstalmentPlanViewModel : ViewModelBase
    {
        ...
        public bool InstalmentSliderVisible
        {
            set
            {
                if (instalmentSliderVisible != value)
                {
                    ...
                    RaisePropertyChanged("InstalmentSliderVisible");
                }
            }
            get
            {
        ...
        public string PickedFinancialStatement
        {
            ...
            set
            {
                ...
                RaisePropertyChanged("PickedFinancialStatement");
            }
        }
        ...
        public GenericPickerModel YesNoPickerModel
        {
            ...
            set
            {
                ...
                RaisePropertyChanged("YesNoPickerModel");
            }
        }
        ...
        public bool IsFinsancialStatementsEditable
        {
            ...
            set
            {
                ...
                RaisePropertyChanged("IsFinsancialStatementsEditable");
            }
        }
        ...
        private Models.ZakatInstalationModels.OldZakatRequestDisplayModel _zakatInstalments;
        public Models.ZakatInstalationModels.OldZakatRequestDisplayModel ZakatInstalments
        {
            get
            {
        ...
        public bool IsInitialDraft
        {
            ...
            set
            {
                ...
                RaisePropertyChanged("IsInitialDraft");
            }
        }
        ...
        public OldZakatInstalmentPlanViewModel(INavigationService navigationService, IDialogService dialogService)
        {
            ...
            InstallmentDetailsBtnTapped = new Command(async () =>
            {
                ...
                //ZakatInstalments.d.ADpAmt = DownPaymentAmount.ToString();
                //ZakatInstalments.d.ATotalAmt = instalmentamount.ToString();
                //ZakatInstalments.d.Savez = "51";
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        if (IsInitialDraft || App.selectedZakatItem != "")
                        {
                            ...
                            //ZakatInstalments.d.Status = "IP017";
                        }
                        else
                        {
                            //ZakatInstalments.d.Fbnum = "";
        ...
        public async Task GetZaktaInvoiceList()
        {
            try
            {
                ...
                for (int i = 0; i < ZakatInstalments.d.Z_INVOICE_UI5Set.results.Count; i++)
                {
                    ...
                    if (double.Parse(ZakatInstalments.d.Z_INVOICE_UI5Set.results[i].AIvAmtTb) > 0)
                    {
                    ...
                    for (int i = 0; i < ZakatInvoicesList.Count; i++)
                {
                    ...
                    // totalAmount += Convert.ToDouble(ZakatInvoicesList[i].AAmtTb);
        ...
        public OldZakatInstalmentPlanRequest BuildRequestObject()
        {
            ...
            if (ZakatInstalments.d.Off_notesSet.results == null)
            {
            ...
            {
                _postData.Off_notesSet = ZakatInstalments.d.Off_notesSet.results.ToArray();
            }
            ...
            if (ZakatInstalments.d.AttDetSet.results == null)
            {
            ...
            else
            {
                ...
                if (ZakatInstalments.d.Z_INVOICE_UI5Set.results.Count != 0)
                {
                        ...
                        if (selectedList.Contains(dataItem))
                        {
                            ...
                            ZakatInstalments.d.Z_INVOICE_UI5Set.results[i].AIvTb = "2";
                        ...
                        if ( apiDate != null && !apiDate.Contains("Date"))
                        {
                            ...
                            DateTime dt = Convert.ToDateTime(ZakatInstalments.d.Z_INVOICE_UI5Set.results[i].ADueDtTb);
                            JsonSerializerSettings microsoftDateFormatSettings = new JsonSerializerSettings
                            {
                                DateFormatHandling = DateFormatHandling.MicrosoftDateFormat
                            };
                            ...
                            jsonDateTime = dateList[0].Replace("\"\\", "");
                            jsonDateTime = jsonDateTime + ")/";
                            ZakatInstalments.d.Z_INVOICE_UI5Set.results[i].ADueDtTb = jsonDateTime;



                        }

                        ZakatInstalments.d.Z_INVOICE_UI5Set.results[i].AAmtTb = ZakatInstalments.d.Z_INVOICE_UI5Set.results[i].AIvAmtTb;

                      

                            if (ZakatInstalments.d.Z_INVOICE_UI5Set.results[i].AIvAbtyp.Equals(AppResources.ZakatInstalmetSelectTypeIncomeTax))
                            {

                                ZakatInstalments.d.Z_INVOICE_UI5Set.results[i].AIvAbtyp = "ITAX";
                            }
                            else if (ZakatInstalments.d.Z_INVOICE_UI5Set.results[i].AIvAbtyp.Equals(AppResources.FORM5Zakat))
                            {

                                ZakatInstalments.d.Z_INVOICE_UI5Set.results[i].AIvAbtyp = "ZAKT";
                            }

                        
                    }

                    _postData.Z_INVOICE_UI5Set = ZakatInstalments.d.Z_INVOICE_UI5Set.results.ToArray();
            ...
            //        string apiDate = invoicesList[0].ADueDtTb;
            //        if (!apiDate.Contains("Date"))
            //        {
            ...
            //                DateTime dt = Convert.ToDateTime(invoicesList[i].ADueDtTb);
            //                JsonSerializerSettings microsoftDateFormatSettings = new JsonSerializerSettings
            //                {
            //                    DateFormatHandling = DateFormatHandling.MicrosoftDateFormat
            //                };
            ...
            //                jsonDateTime = dateList[0].Replace("\"\\", "");
            //                jsonDateTime = jsonDateTime + ")/";
            //                invoicesList[i].ADueDtTb = jsonDateTime;
        ...
        public async Task<OldZakatRequestDisplayModel> SubmitClicked()
        {
            ...
            try
            {
                ...
                if (FinanceAttachmentsListViewData != null && FinanceAttachmentsListViewData.Count > 0)
                {
                ...
                double dueAmount = double.Parse(DownPaymentSliderValue.ToString().Replace(" SAR", ""));
                if (dueAmount != 0)
                {
