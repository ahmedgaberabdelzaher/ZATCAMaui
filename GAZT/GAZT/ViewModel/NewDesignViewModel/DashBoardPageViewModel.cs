    ...
    public class GAZTNewDesignDashBoardPageViewModel : BaseViewModel
    {
        ...
        public void verifyPaymentAndShowBillsPopup(OverduePaymentAndUnSubmittedReturn BModel)
        {
           ...
           var newMultiplePayableBills = new ObservableCollection<MyBills>();
            ...
            {
                MultiplePayableBills = new ObservableCollection<MyBills>(newMultiplePayableBills.Where(x => !String.IsNullOrEmpty(BModel.Fbnum) && x.VTRE2.Equals(BModel.Fbnum)).ToList());
            }
