...
namespace GAZT.Helper
{
    ...
    public static class Constants
    {
        ...
        public static string GetAllTin = BaseUrlOfODataServices + "/sap/opu/odata/SAP/ZDP_GET_TIN_DATA_SRV/HeaderSet?$filter=Email eq'";
        ...
        public static string ChangePassword = BaseUrlOfODataServices + "/sap/opu/odata/SAP/ZDP_FRGT_USRNM_PWD_SRV/SecuredHeaderSet?saml2=enabled";
        ...
        public static string GetVATObjViewApplicationDREGReasonSetURL = BaseUrlOfODataServices + "/sap/opu/odata/SAP/ZDP_VAT_NW_DREG_SRV/GetReasonSet?$filter=TxnTp eq 'VT_DREG' and Lang eq ";
