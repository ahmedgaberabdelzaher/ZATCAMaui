...
namespace GAZT.Manager
{
    ...
    public static class WebServiceManager
    {
       ...
       public static async Task<string> GAZTZakatGetPdfUrl(String Lang, String Tin)
        ...
        public static string GAZTDeleteAttachment(string fileName, string RetGuid)
        {
            if (CrossConnectivity.Current.IsConnected)
            {
                string DeleteToken = string.Empty;
        ...
        public static async Task<MadaPaymentResponse> GAZTUpdateMadaPaymentDetails(string caseGuid, string devicetype)
        {
            ...
            if (CrossConnectivity.Current.IsConnected)
            {
                ...
                try
                {
                    ...
                    HttpClient client = new HttpClient(App.httpClientHandler);
                    String uri = Constants.UpdateMadaPaymentInformation + "'" + caseGuid + "',Srcid='" + devicetype + "')" + "?$format=json";
