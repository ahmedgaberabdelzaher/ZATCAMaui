...
namespace ZATCAMAUI.ViewModel.NewDesignViewModel.EstablishmentAmendUpdateViewModel
{
    ...
    public class EstablishmentAmendUpdateSuccessfulPageViewModel : BaseViewModel
    {
        ...
        #endregion
        public EstablishmentAmendUpdateSuccessfulPageViewModel(INavigationService navigationService, IDialogService dialogService) : base(navigationService, dialogService)
        {
