...
namespace ZATCAMAUI.ViewModel.NewDesignViewModel.NF;

public class NFLoginViewModel : BaseViewModel
{
    public int CurrentAttempt = 0;


    public NFLoginViewModel(INavigationService navigationService, IDialogService dialogService):base(navigationService,dialogService)
    {
    }
