...
using Metadata = ZATCAMAUI.Models.VATReviewModel.Metadata;
using NotesSet = ZATCAMAUI.Models.VATReviewModel.NotesSet;
...
namespace ZATCAMAUI.ViewModel.NewDesignViewModel.VATReviewViewModel
{
    ...
    public class VatReviewViewModel : BaseViewModel
    {
        ...
        public ICommand OnInfoButtonTapped { get; set; }
        public ICommand OnAppearingVatReviewCommand { get; set; }
        ...
        public string SadadlastFulfilmentDate = string.Empty;
        ...
        public bool ReviewReasonVisible
        {
            ...
            set
            {
                ...
                OnPropertyChanged("ReviewReasonVisible");
            }
        }
        ...
        public bool ReviewDetailsVisible
        {
            ...
            set
            {
                ...
                OnPropertyChanged("ReviewDetailsVisible");
            }
        }
        ...
        public bool ReportDetailsVisible
        {
            ...
            set
            {
                ...
                OnPropertyChanged("ReportDetailsVisible");
            }
        }
        ...
        public bool SecurityPaymentVisible
        {
            ...
            set
            {
                ...
                OnPropertyChanged("SecurityPaymentVisible");
            }
        }
        ...
        public bool LateFilingObjectionsVisible
        {
            ...
            set
            {
                ...
                OnPropertyChanged("LateFilingObjectionsVisible");
            }
        }
        ...
        public bool SadadGenerateBtnVisible
        {
            ...
            set
            {
                ...
                OnPropertyChanged("SadadGenerateBtnVisible");
            }
        }
        ...
        public bool SadadGenerateProgressVisible
        {
            ...
            set
            {
                ...
                OnPropertyChanged("SadadGenerateProgressVisible");
            }
        }
        ...
        public bool SadadAmountVisible
        {
            ...
            set
            {
                ...
                OnPropertyChanged("SadadAmountVisible");
            }
        }
        ...
        public string PickedDateFullMonth
        {
            ...
            set
            {
                ...
                OnPropertyChanged("PickedDateFullMonth");
            }
        }
        ...
        public string FormattedRequestDate
        {
            ...
            set
            {
                ...
                OnPropertyChanged("FormattedRequestDate");
            }
        }
        ...
        public string FormattedTaxperdioFromDate
        {
            ...
            set
            {
                ...
                OnPropertyChanged("FormattedTaxperdioFromDate");
            }
        }
        ...
        public string FormattedTaxperdioToDate
        {
            ...
            set
            {
                ...
                OnPropertyChanged("FormattedTaxperdioToDate");
            }
        }
        ...
        public string SecurityNumber
        {
            ...
            set
            {
                ...
                OnPropertyChanged("SecurityNumber");
            }
        }
        ...
        public bool IsSadadCheckBox1
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsSadadCheckBox1");
            }
        }
        ...
        public bool IsSadadCheckBox3
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsSadadCheckBox3");
            }
        }
        ...
        public bool IsSadadCheckBox4
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsSadadCheckBox4");
            }
        }
        ...
        public bool IsGeneratingFormbundle
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsGeneratingFormbundle");
            }
        }
        ...
        public bool IsSadadRefeshVisible
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsSadadRefeshVisible");
            }
        }
        ...
        public bool IsReportDetailsEditable
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsReportDetailsEditable");
            }
        }
        ...
        public bool IsLateFilingDetailsEditable
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsLateFilingDetailsEditable");
            }
        }
        ...
        public bool IsDisputeDetailsEditable
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsDisputeDetailsEditable");
            }
        }
        ...
        public bool DAPOptionsEditable
        {
            ...
            set
            {
                ...
                OnPropertyChanged("DAPOptionsEditable");
            }
        }
        ...
        public bool IsSecurityPOEditable
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsSecurityPOEditable");
            }
        }
        ...
        public GenericPickerModel ReviewReasonPickerModel
        {
            ...
            set
            {
                ...
                OnPropertyChanged("ReviewReasonPickerModel");
            }
        }
        ...
        public GenericPickerModel ReviewSubReasonPickerModel
        {
            ...
            set
            {
                ...
                OnPropertyChanged("ReviewSubReasonPickerModel");
            }
        }
        ...
        public GenericPickerModel ApplicationRefPickerModel
        {
            ...
            set
            {
                ...
                OnPropertyChanged("ApplicationRefPickerModel");
            }
        }
        ...
        public bool IsReviewReasonEnabled
        {
            ...
            set
            {
                ...
                ReviewReasonButtonBackGroundColor = (_isReviewReasonEnabled ? (Color)Application.Current.Resources["Secondary"] : (Color)Application.Current.Resources["ButtonGray"]);
                OnPropertyChanged("IsReviewReasonEnabled");
            }
        }

        private Color _reviewReasonButtonBackGroundColor = (Color)Application.Current.Resources["ButtonGray"];
        ...
        public Color ReviewReasonButtonBackGroundColor
        {
            ...
            set
            {
                ...
                OnPropertyChanged("ReviewReasonButtonBackGroundColor");
            }
        }
        ...
        public bool IsReportDetailsEnabled
        {
            ...
            set
            {
                ...
                ReportDetailsButtonBackGroundColor = (_isReportDetailsEnabled ? (Color)Application.Current.Resources["Secondary"] : (Color)Application.Current.Resources["ButtonGray"]);
                OnPropertyChanged("IsReportDetailsEnabled");
            }
        }
        ...
        public bool IsLateFlngDetailsEnabled
        {
            ...
            set
            {
                ...
                LateFilingDetailsButtonBackGroundColor = Color.FromHex(_isLateFlngDetailsEnabled ? "#0996d4" : "#9EA4A9");
                OnPropertyChanged("IsLateFlngDetailsEnabled");
            }
        }

        // private Color _reportDetailsButtonBackGroundColor = Color.FromHex("#9EA4A9");
        private Color _reportDetailsButtonBackGroundColor = (Color)Application.Current.Resources["ButtonGray"];
        ...
        public Color ReportDetailsButtonBackGroundColor
        {
            ...
            set
            {
                ...
                OnPropertyChanged("ReportDetailsButtonBackGroundColor");
            }
        }
        ...
        public bool IsReviewDetailsEnabled
        {
            ...
            set
            {
                ...
                ReviewDetailsButtonBackGroundColor = (_isReviewDetailsEnabled ? (Color)Application.Current.Resources["Secondary"] : (Color)Application.Current.Resources["ButtonGray"]);
                OnPropertyChanged("IsReviewDetailsEnabled");
            }
        }

        private Color _ReviewDetailsButtonBackGroundColor = (Color)Application.Current.Resources["ButtonGray"];
        ...
        public Color ReviewDetailsButtonBackGroundColor
        {
            ...
            set
            {
                ...
                OnPropertyChanged("ReviewDetailsButtonBackGroundColor");
            }
        }
        ...
        public Color LateFilingDetailsButtonBackGroundColor
        {
            ...
            set
            {
                ...
                OnPropertyChanged("LateFilingDetailsButtonBackGroundColor");
            }
        }
        ...
        public bool IsSecurityPaymentEnabled
        {
            ...
            set
            {
                ...
                SecurityPaymentButtonBackGroundColor = (_isSecurityPaymentEnabled ? (Color)Application.Current.Resources["Secondary"] : (Color)Application.Current.Resources["ButtonGray"]);
                OnPropertyChanged("IsSecurityPaymentEnabled");
            }
        }

        private Color _SecurityPaymentButtonBackGroundColor = (Color)Application.Current.Resources["ButtonGray"];
        ...
        public Color SecurityPaymentButtonBackGroundColor
        {
            ...
            set
            {
                ...
                OnPropertyChanged("SecurityPaymentButtonBackGroundColor");
            }
        }
        ...
        public string VBDocumentNumber
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VBDocumentNumber");
            }
        }
        ...
        public string VBSadadNumber
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VBSadadNumber");
            }
        }
        ...
        public string VBDateofPenality
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VBDateofPenality");
            }
        }
        ...
        public string VBDescriptionOfPenality
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VBDescriptionOfPenality");
            }
        }
        ...
        public string VATaxpayerName
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VATaxpayerName");
            }
        }
        ...
        public string VAVATReturnType
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VAVATReturnType");
            }
        }
        ...
        public string VAVatReturnReferenceNo
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VAVatReturnReferenceNo");
            }
        }

        ////ViewBill Fixes --- >
        //public VATObjectionFormViewBillModel _billFormModelfrPopup { get; set; }
        //public VATObjectionFormViewBillModel BillFormModelfrPopup
        //{
        //    get
        //    {
        //        return _billFormModelfrPopup;
        //    }
        //    set
        //    {
        //        if (_billFormModelfrPopup == value) return;
        //        _billFormModelfrPopup = value;
        //        OnPropertyChanged("BillFormModelfrPopup");
        //    }
        //}
        ...
        public string VAVatAccountNum
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VAVatAccountNum");
            }
        }
        ...
        public string VASalesAmount
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VASalesAmount");
            }
        }
        ...
        public string VASalesVatAdjustment
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VASalesVatAdjustment");
            }
        }
        ...
        public string VAVatOnSales
        {
            ...
            set
            {
                ...
                _vAVatOnSales = value;
                OnPropertyChanged("VAVatOnSales");
            }
        }
        ...
        public string VAPurchaseAmount
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VAPurchaseAmount");
            }
        }
        ...
        public string VAPurchaseVatAdjustment
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VAPurchaseVatAdjustment");
            }
        }
        ...
        public string VAVatOnPurchase
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VAVatOnPurchase");
            }
        }
        ...
        public string VATotalDueVAT
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VATotalDueVAT");
            }
        }
        ...
        public string VATotalCreditVAT
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VATotalCreditVAT");
            }
        }
        ...
        public string VACorrrections
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VACorrrections");
            }
        }
        ...
        public string ViewApplicationTypeText
        {
            ...
            set
            {
                ...
                OnPropertyChanged("ViewApplicationTypeText");
            }
        }
        ...
        public string TotalTaxLiability
        {
            ...
            set
            {
                ...
                OnPropertyChanged("TotalTaxLiability");
            }
        }
        ...
        public string _taxPaidLable = AppResources.VRTaxPaid;
        public string TaxPaidLable
        {
            get { return _taxPaidLable; }
            set
            {
                if (_taxPaidLable == value) return;

                _taxPaidLable = value;
                OnPropertyChanged("TaxPaidLable");
            }
        }
        ...
        public DateTime? VRTIDEffectiveDateFrom
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRTIDEffectiveDateFrom");
            }
        }
        ...
        public DateTime? VRTIDEffectiveDateTo
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRTIDEffectiveDateTo");
            }
        }
        ...
        public string CIPFTxablePurchases
        {
            ...
            set
            {
                ...
                OnPropertyChanged("CIPFTxablePurchases");
            }
        }
        ...
        public string CIPFExemptPurchases
        {
            ...
            set
            {
                ...
                OnPropertyChanged("CIPFExemptPurchases");
            }
        }
        ...
        public string CITxablePurchases
        {
            ...
            set
            {
                ...
                OnPropertyChanged("CITxablePurchases");
            }
        }
        ...
        public string CIExemptPurchases
        {
            ...
            set
            {
                ...
                OnPropertyChanged("CIExemptPurchases");
            }
        }
        ...
        public string PIPFTxablePurchases
        {
            ...
            set
            {
                ...
                OnPropertyChanged("PIPFTxablePurchases");
            }
        }
        ...
        public string PIPFExemptPurchases
        {
            ...
            set
            {
                ...
                OnPropertyChanged("PIPFExemptPurchases");
            }
        }
        ...
        public string PITxablePurchases
        {
            ...
            set
            {
                ...
                OnPropertyChanged("PITxablePurchases");
            }
        }
        ...
        public string PIExemptPurchases
        {
            ...
            set
            {
                ...
                OnPropertyChanged("PIExemptPurchases");
            }
        }
        ...
        public string VITDReportDetails
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VITDReportDetails");
            }
        }
        ...
        public string VITDIDNumber
        {
            ...
            set
            {
                ...
                vITDIDNumber = value;
                OnPropertyChanged("VITDIDNumber");
            }
        }
        ...
        public string VITDDateOfBirth
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VITDDateOfBirth");
            }
        }
        ...
        public string VITDContactPersonName
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VITDContactPersonName");
            }
        }
        ...
        public string VRVSRequestType
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVSRequestType");
            }
        }
        ...
        public string VRVSStartofSuspensionPeriod
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVSStartofSuspensionPeriod");
            }
        }
        ...
        public string VRVSEndofSuspensionPeriod
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVSEndofSuspensionPeriod");
            }
        }
        ...
        public string VRVSSuspendedfilingperiod
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVSSuspendedfilingperiod");
            }
        }
        ...
        public string VRVSNextfilingperiod
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVSNextfilingperiod");
            }
        }
        ...
        public string VRVSNextfilingduedate
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVSNextfilingduedate");
            }
        }
        ...
        public string VRVSRFSuspensionofFiling
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVSRFSuspensionofFiling");
            }
        }
        ...
        public string VRVSIDNumber
        {
            ...
            set
            {
                ...
                vRVSIDNumber = value;
                OnPropertyChanged("VRVSIDNumber");
            }
        }
        ...
        public string VRVSContactPersonName
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVSContactPersonName");
            }
        }
        ...
        public string VRRequesttoReviewtheAmountValue
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRRequesttoReviewtheAmountValue");
            }
        }
        ...
        public bool IsVITDDOBVisible
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsVITDDOBVisible");
            }
        }
        ...
        public bool IsApplicationVisible
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsApplicationVisible");
            }
        }
        ...
        private bool _isTaxPaidVisible = false;
        public bool IsTaxPaidVisible
        {
            get { return _isTaxPaidVisible; }
            set
            {
                if (_isTaxPaidVisible == value) return;
        ...
        public bool IsDraftClicked
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsDraftClicked");
            }
        }
        private bool _isRRAmountEdit = true;
        public bool IsRRAmountEdit
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsRRAmountEdit");
            }
        }
        ...
        public bool PartialAmountCheckBox
        {
            ...
            set
            {
                ...
                OnPropertyChanged("PartialAmountCheckBox");
            }
        }
        ...
        public string charCountDisputeDetails
        {
            ...
            set
            {
                ...
                OnPropertyChanged("charCountDisputeDetails");
            }
        }
        ...
        public string charCountReportDetails
        {
            ...
            set
            {
                ...
                OnPropertyChanged("charCountReportDetails");
            }
        }
        ...
        public string charCountLateFilingDetails
        {
            ...
            set
            {
                ...
                _charCountReportDetails = value;
                OnPropertyChanged("charCountLateFilingDetails");
            }
        }
        ...
        public ObservableCollection<Attachment> VITDAttachmentsListViewData
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VITDAttachmentsListViewData");
            }
        }
        ...
        public ObservableCollection<Attachment> VSVRAttachmentsListViewData
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VSVRAttachmentsListViewData");
            }
        }
        ...
        public ObservableCollection<Attachment> VatDeRegAttachmentsList
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VatDeRegAttachmentsList");
            }
        }
        ...
        public ObservableCollection<SelectionModel> DisputeAmountPaymentOptions
        {
            ...
            set
            {
                ...
                OnPropertyChanged("DisputeAmountPaymentOptions");
            }
        }
        ...
        public string VRVGVATeligiblesupplies
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVGVATeligiblesupplies");
            }
        }
        ...
        public string VRVGVATeligiblepurchases
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVGVATeligiblepurchases");
            }
        }
        ...
        public string VRVGEffectivedate
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVGEffectivedate");
            }
        }
        ...
        public ObservableCollection<Attachment> VRVGAttachmentsListViewData
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVGAttachmentsListViewData");
            }
        }
        ...
        public ObservableCollection<VATReviewRequestVTGRModel.TABLESetResult> VRVGTinsListViewData
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVGTinsListViewData");
            }
        }
        ...
        public string VRVGIDNumber
        {
            ...
            set
            {
                ...
                _VrVGIDNumber = value;
                OnPropertyChanged("VRVGIDNumber");
            }
        }
        ...
        public string VRVGContactPersonName
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VRVGContactPersonName");
            }
        }
        ...
        public int DefaultSecurity
        {
            ...
            set
            {
                ...
                OnPropertyChanged("DefaultSecurity");
            }
        }
        ...
        public string VrVRIDNumber
        {
            ...
            set
            {
                ...
                _VrVRIDNumber = value;
                OnPropertyChanged("VrVRIDNumber");
            }
        }
        ...
        public string VrVRContactPersonName
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRContactPersonName");
            }
        }
        ...
        public bool IsSadadCheckBoxEnabled
        {
            ...
            set
            {
                ...
                OnPropertyChanged("IsSadadCheckBoxEnabled");
            }
        }
        ...
        public string VrVRContactDOB
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRContactDOB");
            }
        }
        ...
        public string VrVRIdNumberSR
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRIdNumberSR");
            }
        }
        ...
        public string VrVRFirstNameSR
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRFirstNameSR");
            }
        }
        ...
        public string VrVRLastnmFR
        {
            ...
            set
            {
                ...
                _VrVRlastnmFR = value;
                OnPropertyChanged("VrVRLastnmFR");
            }
        }
        ...
        public string VrVRMobNumberFR
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRMobNumberFR");
            }
        }
        ...
        public string VrVRVatEligibleStartDate
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRVatEligibleStartDate");
            }
        }
        ...
        public string VrVRquesTion3answerSelected
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRquesTion3answerSelected");
            }
        }
        ...
        public string VrVRquesTion4answerSelected
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRquesTion4answerSelected");
            }
        }
        ...
        public string VrVRquesTion1answerSelected
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRquesTion1answerSelected");
            }
        }
        ...
        public string VrVRquesTion2answerSelected
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRquesTion2answerSelected");
            }
        }
        ...
        public string VrVRIdnumberFR
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRIdnumberFR");
            }
        }
        ...
        public string VrVRFirstnmFR
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRFirstnmFR");
            }
        }
        ...
        public string VrVRSmtpAddrFR
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRSmtpAddrFR");
            }
        }
        ...
        public string VrVRImportExportText
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRImportExportText");
            }
        }
        ...
        public string LastFulfilmentDateText
        {
            ...
            set
            {
                ...
                OnPropertyChanged("LastFulfilmentDateText");
            }
        }

        private string _sadadLastFulfilmentDateText = string.Empty;
        public string SadadLastFulfilmentDateText
        {
            get
            {
                return _sadadLastFulfilmentDateText;
            }
            set
            {
                if (_sadadLastFulfilmentDateText == value) return;

                _sadadLastFulfilmentDateText = value;
                OnPropertyChanged("SadadLastFulfilmentDateText");
            }
        }
        ...
        public string VrVRAttachmentName
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRAttachmentName");
            }
        }
        ...
        public VATRegistrationDetails VrVRVATRegistrationDetailsData
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRVATRegistrationDetailsData");
            }
        }
        ...
        public List<QuestionNumberWithMinMaxRange> VrVRMinMaxRanges
        {
            ...
            set
            {
                ...
                OnPropertyChanged("VrVRMinMaxRanges");
            }
        }
        ...
        public ObservableCollection<Result2> VrVRIbanList
        {
            ...
            set
            {
                ...
                _VrVRibanList = value;
                OnPropertyChanged("VrVRIbanList");
            }
        }
        ...
        public VatReviewViewModel(INavigationService navigationService, IDialogService dialogService) : base(navigationService, dialogService)
        {
            ...
            ReviewReasonConBtnTapped = new Command(async () => { await ReviewReasonConBtnClicked(); });

            ReviewDetailsConBtnTapped = new Command(async () => { await ReviewDetailsConBtnClicked(); });
            ReportDetailsConBtnTapped = new Command(async () => { await ReportDetailsConBtnClicked(); });
            LateFilingContdButtonClicked = new Command(async () => { await LateFilingConBtnClicked(); });
            SecurityPaymentConBtnTapped = new Command(async () => { await SecurityPaymentConBtnClicked(); });
            ...
            ViewApplicationTapped = new Command(async () => { await ViewApplicationClicked(); });
            NewAttachmentTapped = new Command(async () => { await NewAttachmentClicked(); });
            NewBankGuranteeAttachmentTapped = new Command(async () => await NewBankGuranteeAttachmentClicked());
            LateFilingAttachmentTapped = new Command(async () => await LateFilingAttachmentClicked());
            ReviewReasonCommand = new Command(async () => { await showReviewReasonPickerDialog(); });
            SubReviewReasonCommand = new Command(async () => { await showSubReviewReasonPickerDialog(); });
            ApplicationNumRefCommand = new Command(async () => { await showAppRefNumberPickerDialog(); });
            SadadGenerateBtnTapped = new Command(async () => { await ShowSADADConfirmation(); });
            ShowDatePicker = new Command(async () => { await showDatePickerDialog(); });
            IdTypeSpinnerTapped = new Command(async () => { await showIdTypePickerDialog(); });
            ...
            OnAppearingVatReviewCommand = new Command(async () =>
            {
                try
                {
                    await ResetData();
                    ...
                    await VatReviewReasonDropDownData();
                    ...
                    {
                        DisputeSelectedItem = DisputeAmountPaymentOptions[arg];

                    });

                    MessagingCenter.Subscribe<object, int>(this, "draftSecurity", (sender, arg) =>
                    {
                        SelectedOption = SecurityPaymentOptions[arg];
                        if (arg == 0)
                        {
            ...
            OnInfoButtonTapped = new Command(async () =>
            {
                try
                {
                    IsLoading = true;
        ...
        {
            DisputeSelectedItem = DisputeAmountPaymentOptions[DefaultReq];

            SelectedOption = SecurityPaymentOptions[DefaultSecurity];
        ...
        public async Task NewBankGuranteeAttachmentClicked()
        {
            if (MopupService.Instance.PopupStack.Count > 0) return;
        ...
        public async Task LateFilingAttachmentClicked()
        {
            if (MopupService.Instance.PopupStack.Count > 0) return;
        ...
        private async Task showReviewReasonPickerDialog()
        {
            try
            {
        ...
        private async Task showSubReviewReasonPickerDialog()
        {
            try
            {
        ...
        private async Task showAppRefNumberPickerDialog()
        {
            try
            {
        ...
        private async Task ReviewReasonConBtnClicked()
        {
            try
            {
        ...
        private async Task ReportDetailsConBtnClicked()
        {
            try
            {
        ...
        private async Task ReviewDetailsConBtnClicked()
        {
            try
            {
        ...
        private async Task LateFilingConBtnClicked()
        {
            try
            {
        ...
        private async Task SecurityPaymentConBtnClicked()
        {
            try
            {
        ...
        public void FetchSecurityAmount()
        {
            ...
            try
            {
                VATObjectionSecurityAmount(Convert.ToDecimal(RequestedReviewAmount),
                    ...
                    Convert.ToDecimal(selectedApplicationRef.Clramt), selectedApplicationRef.Fbnum);
            }
            catch (Exception)
            {
            ...
            try
            {
                ...
                if (IsGeneratingFormbundle)
                {
                    ...
                    if (modelVATReview != null && modelVATReview.d != null)
                    {
                        ...
                        await VATObjectionGenrateorRefreshSADAD(modelVATReview.d.Fbnumx, DisamtValue, LiaamtValue, selectedApplicationRef.Abrzu, selectedApplicationRef.Abrzo, SecamtValue, SecurityNumber, selectedApplicationRef.Persl, false);
        ...
        public async Task GenerateSadadNumberAsync()
        {
            ...
            if (IsGeneratingFormbundle)
            {
                try
                {
                    ...
                    await VATObjectionGenrateorRefreshSADAD(modelVATReview.d.Fbnumx, DisamtValue, LiaamtValue, selectedApplicationRef.Abrzu, selectedApplicationRef.Abrzo, SecamtValue, SecurityNumber, selectedApplicationRef.Persl, true);
        ...
        public async Task ShowSADADConfirmation()
        {
            IsLoading = true;
            if (IsGeneratingFormbundle)
            {
            ...
            else
            {
                ...
                await _dialogService.ShowMessage(message: AppResources.VRSadadAlert, title: AppResources.ZZZConfirmationMsg,
                 ...
                 afterHideCallback: async (status) => await GenerateSadadConfirmaton(status));
            }
            IsLoading = false;
        }

        public async Task GenerateSadadConfirmaton(bool status)
        {
            if (status)
            {
                await GenerateSadadNumberAsync();
        ...
        private async Task ViewApplicationClicked()
        {
            if (selectedReviewReason.ProcCD == "VTPC" || selectedReviewReason.ProcCD == "VTPN")
            {
        ...
        public async Task updatePickerData(GenericPickerModel genericPickerModel)
        {
        ...
        public async Task setDataBasedOnAppRefNum(string appRefNum)
        {
            ...
            if (selectedApplicationRef != null)
            {
                ...
                RequestDate = Convert.ToDateTime(selectedApplicationRef.DecDt);
                ...
                if (selectedApplicationRef.DecDt != null)
                {
                    ...
                    dateStart = Convert.ToDateTime(selectedApplicationRef.DecDt);
                ...
                TaxPeriodFrom = Convert.ToDateTime(selectedApplicationRef.Abrzu);
                TaxPeriodTo = Convert.ToDateTime(selectedApplicationRef.Abrzo);
                ...
                if (selectedApplicationRef.Abrzu != null)
                {
                    try
                    {
                        ...
                        dateStart = Convert.ToDateTime(selectedApplicationRef.Abrzu);
                ...
                if (selectedApplicationRef.LastFulfilledDt == null)
                {
                    lastFulfilmentDate = "";
                }
                else
                {
                    try
                    {
                        lastFulfilmentDate = (selectedApplicationRef.LastFulfilledDt);
                    }
                    catch (Exception)
                    {
                        lastFulfilmentDate = "";
                ...
                try
                {
                    SadadlastFulfilmentDate = (selectedApplicationRef.LastFulfilledDt);
                }
                catch (Exception)
                {
                    SadadlastFulfilmentDate = "";
                }

                if (OverdueFlag == "X")
                {
                    LastFulfilmentDateText = AppResources.VRSecurityBankGurrantCheckBoxDesc1;
                    SadadLastFulfilmentDateText = AppResources.VRSecuritySadadCheckBoxDesc1;
                }
                else
                {
                    LastFulfilmentDateText = string.Format(AppResources.VRSecurityBankGuarante, lastFulfilmentDate);
                    SadadLastFulfilmentDateText = string.Format(AppResources.VRSecuritySadadCheckBoxDesc, SadadlastFulfilmentDate);
                }
                ...
                if (selectedApplicationRef.Abrzo != null)
                {
                    ...
                    dateStart = Convert.ToDateTime(selectedApplicationRef.Abrzo);
        ...
        public async Task ResetData()
        {
            ...
            ReviewReasonButtonBackGroundColor = (Color)Application.Current.Resources["ButtonGray"];
            IsReviewDetailsEnabled = false;
            //ReviewDetailsButtonBackGroundColor = Color.FromHex("#9EA4A9");
            LateFilingDetailsButtonBackGroundColor = Color.FromArgb("#9EA4A9");
            ReviewDetailsButtonBackGroundColor = (Color)Application.Current.Resources["ButtonGray"];
            IsSecurityPaymentEnabled = false;
            SecurityPaymentButtonBackGroundColor = (Color)Application.Current.Resources["ButtonGray"];
            IsDeclarationEnabled = false;
            DeclarationButtonBackGroundColor = (Color)Application.Current.Resources["ButtonGray"];
        ...
        public async Task PopulateDraftData()
        {
            ...
            await setDataBasedOnAppRefNum(ApplicationRefNumber);
            ...
            foreach (var attach in modelVATReview.d.AttdetSet)
            {
            ...
            if (modelVATReview.d.NotesSet.Count > 0)
            {


                foreach (var note in modelVATReview.d.NotesSet)
                {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (modelVATReview != null && modelVATReview.d != null)
                    {
                        ...
                        if (modelVATReview.d.MainReasonSet.Count > 0)
                        {

                            for (int i = 0; i < modelVATReview.d.MainReasonSet.Count; i++)
                            {

                                VATObjectionFormModel.ReviewReason obj = new VATObjectionFormModel.ReviewReason();
                                obj.ProcCD = modelVATReview.d.MainReasonSet[i].ProcCd;
                                obj.Reasons = modelVATReview.d.MainReasonSet[i].TypeT;
                                if (modelVATReview.d.ReasonSet.Where(x =>
                                    x.ProcCd == modelVATReview.d.MainReasonSet[i].ProcCd).Count() > 0)
                                {
                                    List<VATObjectionFormModel.SubReason> subReasonList =
                                        new List<VATObjectionFormModel.SubReason>();
                                    var lstSub = modelVATReview.d.ReasonSet.Where(x =>
                                        x.ProcCd == modelVATReview.d.MainReasonSet[i].ProcCd).ToList();
        ...
        public async Task VATObjectionEnableSubmit(string statusx, string rvRsn, string rvSubRsn, string rejFb)
        {
        ...
        public async Task VATObjectionDownloadAck(string fbnum)
        {
        ...
        public async Task VATObjectionFormRejected(string fbustx, string RvRsn, string rvSubRsn, string UserTypx, string fbnumx, string sopbel)
        {
            try
            {
                ...
                {
                    setApplicationRefPickerModel(_VATObjectionRejected.d.RejectedFormSet);
                }
                IsLoading = false;
            }
            catch (GAZTErrorException ex)
        ...
        public async Task VATObjectionGenrateorRefreshSADAD(string fbnum, decimal Disamt, decimal Liaamt, string Abrzu, string Abrzo, decimal Secamt, string Security, string Persl, bool isFlagenable)
        {
            ...
            {
                IsLoading = true;
                var sadadGenerationObject = buildSadadRequestObject(fbnum, Disamt, Liaamt, Abrzu, Abrzo, Secamt, Security, Persl, isFlagenable);

                VATObjectionGenrateSadadModel _VATObjectionGenrateSadad = new VATObjectionGenrateSadadModel();
                _VATObjectionGenrateSadad = await VATObjectionWebServiceManager.GAZTGetVATObjectionGenrateorRefreshSADAD(sadadGenerationObject);
        ...
        public async Task VATObjectionSecurityAmount(Decimal disamt, Decimal liaamt, Decimal clramt, string fbnum)
        {
            ...
            try
            {
                ...
                _VATObjectionSecurityAmount = await VATObjectionWebServiceManager.GAZTGetVATObjectionSecurityAmount(disamt, liaamt, clramt, fbnum, selectedReviewReason.ProcCD, selectedSubReviewReason.Code);
        ...
        public async Task VATObjectionValidateTaxPayer(string idnum, string idtype, string passExpDt, string taxpDob)
        {
        ...
        public async Task FetchViewBill(string opbel, string vtre2)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        foreach (var item in billModelResult.d)
                        {
                            ...
                            billFormModel.DocumentNumber = VBDocumentNumber;
                            billFormModel.SadadNumber = VBSadadNumber;
                            billFormModel.DescriptionOfPenality = VBDescriptionOfPenality;
                            billFormModel.Periodkey = VBPeriodkey;
                            billFormModel.Amount = VBAmount;
                            ...
                            if (item.Bldat != null)
                            {
                                ...
                                dateStart = Convert.ToDateTime(item.Bldat);
                            ...
                            if (item.Studt != null)
                            {
                                ...
                                dateStart = Convert.ToDateTime(item.Studt);
                            ...
                            if (item.Abrzu != null)
                            {
                                ...
                                dateStart = Convert.ToDateTime(item.Abrzu);
                            ...
                            if (item.Abrzo != null)
                            {
                                ...
                                dateStart = Convert.ToDateTime(item.Abrzo);
                            ...
                            /// -----> ViewBill --->
                            /// 
                            billFormModel.DueDate = VBDueDate;
                            billFormModel.EndDate = VBEndDate;
                            billFormModel.DateofPenality = VBDateofPenality;
                            billFormModel.StartDate = VBStartDate;
        ...
        private SadadGenerationObject buildSadadRequestObject(string fbnum,
    decimal Disamt, decimal Liaamt,
    string Abrzu, string Abrzo, decimal Secamt, string Security,
    string Persl, bool isFlagenable)
        {
            SadadGenerationObject sadadGenerationObject = new SadadGenerationObject();
            sadadGenerationObject.flag = isFlagenable;
            sadadGenerationObject.security = Security;
            sadadGenerationObject.securityAmount = Secamt;
            sadadGenerationObject.periodStartDate = Abrzu;
            sadadGenerationObject.periodEndDate = Abrzo;
            sadadGenerationObject.TIN = App.LoginDataRetrieved.TIN;
            sadadGenerationObject.totalTaxLiability = Liaamt;
            sadadGenerationObject.securityType = "Sadad";
            sadadGenerationObject.periodKey = Persl;
            sadadGenerationObject.disputedAmount = Disamt;



            return sadadGenerationObject;
        ...
        public VatObjectionsRequest BuildRequestObject()
        {
            ...
            _postData.AddressSet = modelVATReview.d.AddressSet;
            _postData.AgreeFg = modelVATReview.d.AgreeFg;
            _postData.Appfg = modelVATReview.d.Appfg;
            _postData.AttdetSet = modelVATReview.d.AttdetSet;
            ...
            _postData.IdDetailSet = modelVATReview.d.IdDetailSet;
            ...
            _postData.QuesListSet = modelVATReview.d.QuesListSet;
            ...
            NotesSetResults notes2 = new NotesSetResults();
            if (OverdueFlag == "X")
            {
                ...
                {
                    notes2 = new NotesSetResults();
                    Metadata _metdata2 = new Metadata();

                    _metdata2.uri = ZATCAConstants.VATObjectionsNotesSet;
                    _metdata2.type = "ZDP_VAT_NW_REV_SRV.Notes";
                    _metdata2.id = ZATCAConstants.VATObjectionsNotesSet;
            ...
            NotesSetResults notes1 = new NotesSetResults();
            ...
            _metdata1.uri = ZATCAConstants.VATObjectionsNotesSet;
            _metdata1.type = "ZDP_VAT_NW_REV_SRV.Notes";
            _metdata1.id = ZATCAConstants.VATObjectionsNotesSet;
            ...
            var NotesetResult = new NotesSet();
            ...
            _postData.MainReasonSet = modelVATReview.d.MainReasonSet;

            _postData.AttdetSet = modelVATReview.d.AttdetSet;
            _postData.ReasonSet = modelVATReview.d.ReasonSet;
        ...
        public async Task<VATObjectionSummaryModel> SubmitClicked()
        {
            ...
            try
            {
                ...
                modelVATReview.d.CalTyp = "Gregorian";
        ...
        {
            DateTime dateTime = DateTime.ParseExact(date, "MM/dd/yyyy h:mm:ss tt", null);
        ...
        {
            long unixTimestamp = long.Parse(date.Substring(6, date.Length - 8));
        ...
        public async Task GetViewApplication(string Fbguid, string Fbnumz, string EUser)
        {
            try
            {
                ...
                {
                    VATinNumber = _vATDeclaration.data.Gpart;
                    VAAccNumber = _vATDeclaration.data.Fin;
                    VAIdnumber = _vATDeclaration.data.Idnumber;
                    VATaxpayerName = _vATDeclaration.data.Tpnm;
                    if (_vATDeclaration.data.ADRSet.Count > 0)
                    {
                        VAAddress = _vATDeclaration.data.ADRSet[0].BuildingNo + "," +
                                    _vATDeclaration.data.ADRSet[0].Street + "," +
                                    _vATDeclaration.data.ADRSet[0].Addrnumber + "," +
                                    _vATDeclaration.data.ADRSet[0].RegionDesc + "," +
                                    _vATDeclaration.data.ADRSet[0].City + "," +
                                    _vATDeclaration.data.ADRSet[0].PostalCd;
                    }
                    else
                    {
                        VAAddress = "";
                    ...
                    VASalesVatAdjustment = _vATDeclaration.data.TotalsalesAdj;
                    VAVatOnSales = _vATDeclaration.data.TotalsalesVat;
                    VAPurchaseAmount = _vATDeclaration.data.TotalpurchaseAmt;
                    VAVatOnPurchase = _vATDeclaration.data.TotalpurchaseVat;
                    VAPurchaseVatAdjustment = _vATDeclaration.data.TotalpurchaseAdj;
                    VATotalDueVAT = _vATDeclaration.data.TotaldueVat;
                    VATotalCreditVAT = _vATDeclaration.data.CreditVat;
                    VACorrrections = _vATDeclaration.data.Preperiodcorr;
                    VANetVat = _vATDeclaration.data.NetdueVat;

                    await _navigationService.NavigateTo(App.VatReviewViewApplicationPageView, this);
                }
                else
                {
                    await _dialogService.ShowMessage(AppResources.ZZSomethingwentwrong, AppResources.Information);
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (vATRegistration != null && vATRegistration.d != null)
                    {
                        ...
                        {
                            VrVRGpartFR = vATRegistration.d.CONTACT_PERSONSet[0].Gpart;
                            //  VATRegistrationDetailsData.d.CONTACT_PERSONSet.results[0].Type = SelectedIdTypeFR.ID;
                            vrVRIdnumber = string.Empty;
                            vrVRIdnumber = vATRegistration.d.CONTACT_PERSONSet[0].Idnumber;
                            VrVRFirstnmFR = vATRegistration.d.CONTACT_PERSONSet[0].Firstnm;
                            VrVRLastnmFR = vATRegistration.d.CONTACT_PERSONSet[0].Lastnm;
                            VrVRMobNumberFR = vATRegistration.d.CONTACTDTSet[0].MobNumber;
                            VrVRSmtpAddrFR = vATRegistration.d.CONTACTDTSet[0].SmtpAddr;
                            VrVRDOB = vATRegistration.d.CONTACT_PERSONSet[0].Dobdt;
                    ...
                    {
                        VrVRIbanList = new ObservableCollection<Result2>(vATRegistration.d.IBANSet);
                    ...
                    await _navigationService.NavigateTo(App.VRVatRegViewPageView);
                }
                    ...
                    if (vATDeRegistration != null && vATDeRegistration.d != null)
                    {
                        ...
                        if (vATDeRegistration.d.headerSet.Idnumbr != null)
                            ...
                            if (string.IsNullOrEmpty(IDType))
                            {
                                ...
                                PopulateVatDeRegSummaryDeclarationData(vATDeRegistration.d.headerSet.Type, vATDeRegistration.d.headerSet.Idnumbr, vATDeRegistration.d.headerSet.Declaredt, vATDeRegistration.d.headerSet.Contactnm);
                            }

                        PopulateVatDeRegAttachments(vATDeRegistration.d.AttdetSet);

                        PopulateVatDeRegSummaryReasonData(vATDeRegistration.d.headerSet.Type, vATDeRegistration.d.headerSet.Reason);

                        await _navigationService.NavigateTo(App.VRVatDeRegViewAppPageView);
                ...
                try
                {
                    ...
                    if (vatReviewFBguid != null && vatReviewFBguid.d != null)
                    {
                        ...
                        if (_VATReviewRequestTPFV != null && _VATReviewRequestTPFV.d != null)
                        {
                            ...
                            if (_VATReviewRequestTPFV.d.NotesSet.Where(x => x.AttByz.ToUpper() == "TP").Count() > 0)
                            {
                                VITDReportDetails =
                                    _VATReviewRequestTPFV.d.NotesSet.First(x => x.AttByz.ToUpper() == "TP").Strline;
                            }
                            var attachmentList = new ObservableCollection<Attachment>();
                            foreach (var attachment in _VATReviewRequestTPFV.d.AttdetSet)
                            {
                            ...
                            await _navigationService.NavigateTo(App.VRInputTDViewAppPageViewApp);
                        }
                        else
                        {
                            await _dialogService.ShowMessage(AppResources.ZZSomethingwentwrong, AppResources.Information);
                ...
                try
                {
                    ...
                    if (_dregInputResult != null && _dregInputResult.d != null)
                    {
                        ...
                        if (dregresult != null && dregresult.d != null)
                        {
                            ...
                            Where(x => x.Reason == dregresult.d.HeaderSet.Reason).FirstOrDefault().Rdesc;

                            _vATDREGViewApllicationViewModel.ContactPersonName = dregresult.d.HeaderSet.Contactnm;
                            _vATDREGViewApllicationViewModel.DeclarationId = dregresult.d.HeaderSet.Idnumbr;

                            var declarationDate = dregresult.d.HeaderSet.Declaredt;

                            PopulateVatDeRegSummaryDeclarationData(IDToNameDictionary[dregresult.d.HeaderSet.Type], dregresult.d.HeaderSet.Idnumbr, declarationDate, dregresult.d.HeaderSet.Contactnm);
                            PopulateVatDeRegAttachments(dregresult.d.AttdetSet);
                            PopulateVatDeRegSummaryReasonData(dregresult.d.HeaderSet.Reqtp, _vATDREGViewApllicationViewModel.ReasonforDeRegistration);
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (_VATReviewRequestVTGR != null && _VATReviewRequestVTGR.d != null)
                    {
                        ...
                        try
                        {
                            VRVGEffectivedate = _VATReviewRequestVTGR.d.EFFDATESet.Where(x => x.Persl == _VATReviewRequestVTGR.d.Persl).FirstOrDefault().Txt50;
                        }
                        catch (Exception)
                        {
                        ...
                        if (_VATReviewRequestVTGR.d.TABLESet != null)
                        {

                            var tinsListViewData = new ObservableCollection<VATReviewRequestVTGRModel.TABLESetResult>();
                            foreach (VATReviewRequestVTGRModel.TABLESetResult tin in _VATReviewRequestVTGR.d.TABLESet)
                            {
                        ...
                        if (_VATReviewRequestVTGR.d.ATTDETSet != null)
                        {

                            var attachmentsListViewData = new ObservableCollection<Attachment>();
                            foreach (Attachment attachemnt in _VATReviewRequestVTGR.d.ATTDETSet)
                            {
                        ...
                        await _navigationService.NavigateTo(App.VRVatGroupPageView);
                    }
                    else
                    {
                        await _dialogService.ShowMessage(AppResources.ZZSomethingwentwrong, AppResources.Information);
                ...
                try
                {
                    ...
                    if (_dregInputResult != null && _dregInputResult.d != null)
                    {
                        ...
                        if (dregresult != null && dregresult.d != null)
                        {
                            ...
                            VRVSContactPersonName = dregresult.d.HeaderSet.Contactnm;
                            VRVSIDNumber = dregresult.d.HeaderSet.Idnumbr;
                            VRVSIDType = IDToNameDictionary[dregresult.d.HeaderSet.Type];
                            ...
                            String startDate = dregresult.d.HeaderSet.StartDate ?? string.Empty;
                            String endDate = dregresult.d.HeaderSet.EndDate ?? string.Empty;


                            if (startDate != string.Empty)
                            {
                                string trimmedStrtDate = startDate.IndexOf('.') >= 0 ? startDate.Substring(0, startDate.IndexOf('.')) : startDate;
                                string trimmedEndDate = endDate.IndexOf('.') >= 0 ? endDate.Substring(0, endDate.IndexOf('.')) : endDate;

                                var _suspensionResult = await GetVATReviewWebServiceManager.GAZTGetVATReviewDREGSuspensionDetailSet(trimmedStrtDate, trimmedEndDate);
                                if (_suspensionResult != null & _suspensionResult.d.results.Count > 0)
                                {
                                    if (_suspensionResult.d.results[0].StartDate != "")
                                    {

                                        // VRVSStartofSuspensionPeriod = _suspensionResult.d.results[0].StartDate.ToString("dd-MM-yyyy");
                                        VRVSStartofSuspensionPeriod = DateTime.ParseExact(_suspensionResult.d.results[0].StartDate, "yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture).ToString("dd-MM-yyyy");

                                    }

                                    if (_suspensionResult.d.results[0].EndDate != null && _suspensionResult.d.results[0].EndDate != "")
                                    {

                                        //VRVSEndofSuspensionPeriod = _suspensionResult.d.results[0].EndDate.ToString("dd-MM-yyyy");
                                        VRVSEndofSuspensionPeriod = DateTime.ParseExact(_suspensionResult.d.results[0].EndDate, "yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture).ToString("dd-MM-yyyy");

                                    }

                                    if (_suspensionResult.d.results[0].Duedate != null && _suspensionResult.d.results[0].Duedate != "")
                                    {

                                        VRVSNextfilingduedate = DateTime.ParseExact(_suspensionResult.d.results[0].Duedate, "yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture).ToString("dd-MM-yyyy");

                                    }

                                    if (_suspensionResult.d.results[0].SuspDtfrom != null && _suspensionResult.d.results[0].SuspDtfrom != "")
                                    {

                                        VRVSRFSuspensionofFiling = DateTime.ParseExact(_suspensionResult.d.results[0].SuspDtfrom, "yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture).ToString("dd-MM-yyyy") + " - " + DateTime.ParseExact(_suspensionResult.d.results[0].SuspDtto, "yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture).ToString("dd-MM-yyyy");

                                    }

                                    if (_suspensionResult.d.results[0].NextDtfrom != null && _suspensionResult.d.results[0].NextDtfrom != "")
                                    {

                                        VRVSNextfilingperiod = DateTime.ParseExact(_suspensionResult.d.results[0].NextDtfrom, "yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture).ToString("dd-MM-yyyy") + " - " + DateTime.ParseExact(_suspensionResult.d.results[0].NextDtto, "yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture).ToString("dd-MM-yyyy");
                            ...
                            var attachmentList = new ObservableCollection<Attachment>();
                            foreach (var attachment in dregresult.d.AttdetSet)
                            {
                                attachmentList.Add(attachment);
                            }
                            VSVRAttachmentsListViewData = attachmentList;

                            await _navigationService.NavigateTo(App.VRSuspensionViewAppPageView);
                        }
                        else
                        {
                            await _dialogService.ShowMessage(AppResources.ZZSomethingwentwrong, AppResources.Information);
