    ...
    public class TransactionReceptionViewModel : BaseViewModel
    {
        ...
        public ICommand UploadFileCommand
        {
            get
            {
                return new Command(async () =>
                {
                    TransactionUploadedFiles = await PickAndShow(new PickOptions() { PickerTitle = "Pick Files" },
                     TransactionUploadedFiles, AppResources.PDFFileHint, AppResources.NumberofAttachments);
                });
            }
        }
