...
namespace ZATCAMAUI.Models.EDeclerationsModel.SubmitModels
{
    ...
    public class TravelerDeclarationResponse : ObservableRecipient
    {
        ...
        public string FeedbackName
        {
            get
            {
                return NameLocalization.GetLocalizedName(feedback_Arabic, feedback_Enlgish);
            }
        }
        ...
        public string DocumentTypeName
        {
            get
            {
                return NameLocalization.GetLocalizedName(travelDocumentType_Arabic, travelDocumentType_English);
            }
        }
        ...
        public string ArrivingName
        {
            get
            {
                return NameLocalization.GetLocalizedName(arrivingFromDepartingTo_Arabic, arrivingFromDepartingTo_English);
            }
        }
        ...
        public string PortName
        {
            get
            {
                return NameLocalization.GetLocalizedName(portName_Arabic, portName_English);
            }
        }
