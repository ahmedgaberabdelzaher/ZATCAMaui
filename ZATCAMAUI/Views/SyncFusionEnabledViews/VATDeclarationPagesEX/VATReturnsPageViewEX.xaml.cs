    ...
    public partial class VATReturnsPageViewEX : ContentPage
    {
        ...
        private void SfTabView_TabItemTapped(object sender, TabItemTappedEventArgs e)
        {
            try
            {
                ...
                if (e.TabItem.Header == AppResources.ZZInstruction)
                {
                    //No check
                }
                else if (e.TabItem.Header == AppResources.ZZTaxPayerDetails)
                {
                ...
                else if (e.TabItem.Header == AppResources.ZZVATReturnForm)
                {
                ...
                else if (e.TabItem.Header == AppResources.ZZSummary)
                {
        ...
        {
            Resources["searchBarStyleForTPDetails"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageSmallMiniWhiteLabelStyle"];
            Resources["searchBarStyleForVATReturnForm"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageSmallMiniWhiteLabelStyle"];
            Resources["searchBarStyleForSummary"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageSmallMiniWhiteLabelStyle"];
            Resources["searchBarStyleForInstructions"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageMediumMiniGoldLabelStyle"];
        }
        private void ClickGestureRecognizer_ClickedForTPDetails(object sender, EventArgs e)
        {
            Resources["searchBarStyleForInstructions"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageSmallMiniWhiteLabelStyle"];
            Resources["searchBarStyleForVATReturnForm"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageSmallMiniWhiteLabelStyle"];
            Resources["searchBarStyleForSummary"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageSmallMiniWhiteLabelStyle"];
            Resources["searchBarStyleForTPDetails"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageMediumMiniGoldLabelStyle"];
        }
        private void ClickGestureRecognizer_ClickedForVATReturnForm(object sender, EventArgs e)
        {
            ...
            Resources["searchBarStyleForTPDetails"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageSmallMiniWhiteLabelStyle"];
            Resources["searchBarStyleForSummary"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageSmallMiniWhiteLabelStyle"];
            Resources["searchBarStyleForVATReturnForm"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageMediumMiniGoldLabelStyle"];
        }
        private void ClickGestureRecognizer_ClickedForSummary(object sender, EventArgs e)
        {
            Resources["searchBarStyleForInstructions"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageSmallMiniWhiteLabelStyle"];
            Resources["searchBarStyleForTPDetails"] = Microsoft.Maui.Controls.Application.Current.Resources["TabbedPageSmallMiniWhiteLabelStyle"];
            Resources["searchBarStyleForVATReturnForm"] = Application.Current.Resources["TabbedPageSmallMiniWhiteLabelStyle"];
            Resources["searchBarStyleForSummary"] = Application.Current.Resources["TabbedPageMediumMiniGoldLabelStyle"];
        }
        #endregion
        ...
        private void chkDeclaration_CheckedChanged(object sender, CheckedChangedEventArgs e)
        {
            ...
            {
                Resources["searchBarStyleForDeclarationChb"] = Microsoft.Maui.Controls.Application.Current.Resources["GAZTGrayLabelStyleForCaptionFont"];
                // BtnNextStep.IsEnabled = false;
            }
            else
            {
                Resources["searchBarStyleForDeclarationChb"] = Microsoft.Maui.Controls.Application.Current.Resources["GAZTGoldLabelStyleForCaptionFont"];
        ...
        private void EntrySalesGccAmt_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntrySalesGccAmt.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntrySalesGccAdj_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntrySalesGccAdj.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryExportsAmt_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryExportsAmt.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryExportsAdj_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryExportsAdj.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryImportspaidAdj_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryImportspaidAdj.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        {
            Browser.Default.OpenAsync(new Uri("https://www.vat.gov.sa/en/introduction-to-vat/faq/general-faqs"));
        }
        ...
        private void EntryExemptsalesAmtFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryExemptsalesAmt.Text) && EntryExemptsalesAmt.Text.Contains(","))
                {
                    ...
                    EntryExemptsalesAmt.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private async void BPicker1_OkButtonClicked(object sender, EventArgs e)
        {
            IBANType selectedIBANType = viewModel.IBANTypesList[BPicker1.Columns[0].SelectedIndex];
        ...
        private void BPicker1_CancelButtonClicked(object sender, EventArgs e)
        {
        ...
        private void BPicker2_OkButtonClicked(object sender, EventArgs e)
        {
            IBANIDNumber selectedIBANIDNumber = viewModel.IBANIDNumberList[BPicker2.Columns[0].SelectedIndex];
        ...
        private void BPicker2_CancelButtonClicked(object sender, EventArgs e)
        {
        ...
        {
            Result2 selectedIBAN = viewModel.IBANList[BPicker.Columns[0].SelectedIndex];
        ...
        private async void btnSwitch_Clicked(object sender, EventArgs e)
        {
            if (!viewModel.IsSwichButtonEnable)
            {
                ...
                if (App.IsArabic)
                {
                    result = await DisplayAlert(AppResources.ZZZConfirmationMsg, AppResources.ZZZRefundEnableMessage, AppResources.ZZZCancelText, AppResources.ZZZOkayText);
                    if (!result)
                    {
                ...
                {
                    result = await DisplayAlert(AppResources.ZZZConfirmationMsg, AppResources.ZZZRefundEnableMessage, AppResources.ZZZOkayText, AppResources.ZZZCancelText);
                    if (result)
                    {
                        viewModel.IsSwichButtonEnable = true;
                    }
        ...
        private void EntryVatAdjustment5Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryVatAdjustmentWithSAR5.Text) && EntryVatAdjustmentWithSAR5.Text.Contains(","))
                {
                    ...
                    EntryVatAdjustmentWithSAR5.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
