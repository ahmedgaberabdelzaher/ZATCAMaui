...
public partial class NFLoginView : ContentPage
{
	HybridWebView Hybridview;
	NFLoginViewModel viewModel;
	public NFLoginView()
	{
		InitializeComponent();
		viewModel = App.Locator.nFLoginViewModel;
	...
	protected override void OnAppearing()
	{
		...
		Task.Run(async () =>
		{
			try
			{
				VATSignUpCaseId modelSSOID = await TaxEvasionWebServiceManager.GAZTGetVATSignUpCaseId();
