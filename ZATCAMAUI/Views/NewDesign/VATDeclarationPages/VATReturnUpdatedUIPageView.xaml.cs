...
namespace ZATCAMAUI.Views.NewDesign.VATDeclarationPages
{
    ...
    public partial class GAZTNewDesignVATReturnUpdatedUIPageView : ContentPage
    {
        ...
        public GAZTNewDesignVATReturnUpdatedUIPageView(VATDeclaration _vATDeclarationInfo)
        {
            try
            {
                ...
                if (_vATDeclarationInfo.data != null)
                {
                    ...
                    viewModel.VATDeclarationData.data = new VATDeclarationD();
        ...
        {
            if (viewModel.VATDeclarationData.data.StepNumber == "01" || viewModel.VATDeclarationData.data.StepNumber == "1" || viewModel.VATDeclarationData.data.StepNumber == "0" || viewModel.VATDeclarationData.data.StepNumber == "00")
            {
            ...
            else if (viewModel.VATDeclarationData.data.StepNumber == "02" || viewModel.VATDeclarationData.data.StepNumber == "2")
            {
                Instrunctionsclicked();
            }
            else if (viewModel.VATDeclarationData.data.StepNumber == "03" || viewModel.VATDeclarationData.data.StepNumber == "3")
            {
                Instrunctionsclicked();
            }
            else if (viewModel.VATDeclarationData.data.StepNumber == "04" || viewModel.VATDeclarationData.data.StepNumber == "4")
            {
                if (viewModel.VATDeclarationData.data.OpenliMsg == "There is no open liability to be paid against this declaration" || viewModel.VATDeclarationData.data.OpenliMsg == "لا يوجد التزامات حالية متاحة للدفع لهذا الاقرار")
                {
        ...
        public void ShowHideContent(bool IsNewReturn)
        {
            ...
            if (IsNewReturn == true)
            {
                ...
                if (viewModel.VATDeclarationData.data.Yesno == "X")
                {
                    ...
                    viewModel.YesLabelColor = Colors.White;
                    viewModel.NoLabelColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["NeutralBlack"];
                }
                else
                {
                    viewModel.IsFifteenPersenctVisible = true;
                    ...
                    viewModel.YesLabelColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["NeutralBlack"];
                    viewModel.NoLabelColor = Colors.White;
                }


                if (viewModel.VATDeclarationData.data.Cr3487golive == "X")
                {

                    viewModel.IsGovtYesNoVisible = true;

                    if (viewModel.VATDeclarationData.data.GovsupYesno == "X")
                    {
                        ...
                        viewModel.TaxYesLabelColor = Colors.White;
                        viewModel.TaxNoLabelColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["LightBlack"];
                    ...
                    else
                    {
                        ...
                        viewModel.TaxNoLabelColor = Colors.White;
                        viewModel.TaxYesLabelColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["LightBlack"];// ("#232323");
                    }
        ...
        public async Task getActionCommand()
        {
            try
            {
        ...
        public void SetNoteForDraftModes()
        {
            try
            {
                if (viewModel.VATDeclarationData != null && viewModel.VATDeclarationData.data != null && viewModel.VATDeclarationData.data.NOTESSet != null && viewModel.VATDeclarationData.data.NOTESSet != null && viewModel.VATDeclarationData.data.NOTESSet.Count != 0)
                {
        ...
        private void OnClickedFAQ(object sender, EventArgs e)
        {
            ...
            if (App.IsArabic)
            {
                FaqUrl = ZATCAConstants.GAZTFAQARUrl;
            }
            else
            {
                FaqUrl = ZATCAConstants.GAZTFAQEnUrl;
            }
        ...
        private void OnNewStandardRatedSalesAmountClicked(object sender, EventArgs e)
        {
            try
            {
                ...
                if (App.IsArabic)
                {
                    headerAmountInfo.Link = ZATCAConstants.GAZTFAQARUrl;
                }
                else
                {
                    headerAmountInfo.Link = ZATCAConstants.GAZTFAQEnUrl;
                }
        ...
        public bool CheckMandetoryFields()
        {
            ...
            try
            {
                if (viewModel.VATDeclarationData != null && viewModel.VATDeclarationData.data != null && viewModel.VATDeclarationData.data.GoliveFg != "X")
                {
                    ...
                    {
                        if (string.IsNullOrEmpty(EntryVatAmount.Text) || EntryVatAmount.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryVatAdjustmentWithSAR.Text) || EntryVatAdjustmentWithSAR.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryStdsalesVat.Text) || EntryStdsalesVat.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        }
                        if (string.IsNullOrEmpty(EntrySalesGccAmt.Text) || EntrySalesGccAmt.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntrySalesGccAdj.Text) || EntrySalesGccAdj.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryZerosalesAmt.Text) || EntryZerosalesAmt.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryZerosalesAdj.Text) || EntryZerosalesAdj.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryExportsAmt.Text) || EntryExportsAmt.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryExportsAdj.Text) || EntryExportsAdj.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryExemptsalesAmt.Text) || EntryExemptsalesAmt.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryExemptsalesAdj.Text) || EntryExemptsalesAdj.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryStdpurchaseAmt.Text) || EntryStdpurchaseAmt.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryStdpurchaseAdj.Text) || EntryStdpurchaseAdj.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryStdpurchasesVat.Text) || EntryStdpurchasesVat.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        }
                        if (string.IsNullOrEmpty(EntryZVatAmountWithSAR.Text) || EntryZVatAmountWithSAR.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryImportspaidAdj.Text) || EntryImportspaidAdj.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryImportspaidVat.Text) || EntryImportspaidVat.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        }
                        if (string.IsNullOrEmpty(EntryImportsaccAmt.Text) || EntryImportsaccAmt.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryImportsaccAdj.Text) || EntryImportsaccAdj.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryImportsaccVat.Text) || EntryImportsaccVat.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        }
                        if (string.IsNullOrEmpty(EntryZeropurchaseAmt.Text) || EntryZeropurchaseAmt.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryZeropurchaseAdj.Text) || EntryZeropurchaseAdj.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryExemptpurchaseAmt.Text) || EntryExemptpurchaseAmt.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryExemptpurchaseAdj.Text) || EntryExemptpurchaseAdj.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryPreperiodcorr.Text) || EntryPreperiodcorr.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        ...
                        if (string.IsNullOrEmpty(EntryCreditVat.Text) || EntryCreditVat.TextColor == Colors.Red)
                        {
                            IsAllEntered = false;
                        }
        ...
        public bool CheckSalesMandetoryFieldsFor15Percent()
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(EntryVatAmount15.Text) || EntryVatAmount15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryVatAmount5.Text) || EntryVatAmount5.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryVatAdjustmentWithSAR15.Text) || EntryVatAdjustmentWithSAR15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryVatAdjustmentWithSAR5.Text) || EntryVatAdjustmentWithSAR5.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryStdsalesVat15.Text) || EntryStdsalesVat15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                }
        ...
        public bool CheckMandetoryFieldsFor15PercentView()
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(EntryStdpurchaseAmt15.Text) || EntryStdpurchaseAmt15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryStdpurchaseAmt5.Text) || EntryStdpurchaseAmt5.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryStdpurchaseAdj15.Text) || EntryStdpurchaseAdj15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryStdpurchaseAdj5.Text) || EntryStdpurchaseAdj5.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryStdpurchasesVat15.Text) || EntryStdpurchasesVat15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                }

                if (string.IsNullOrEmpty(EntryStdpurchasesVat5.Text) || EntryStdpurchasesVat5.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                }
                ...
                if (string.IsNullOrEmpty(EntryZVatAmountWithSAR15.Text) || EntryZVatAmountWithSAR15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryZVatAmountWithSAR5.Text) || EntryZVatAmountWithSAR5.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryImportspaidAdj15.Text) || EntryImportspaidAdj15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryImportspaidAdj5.Text) || EntryImportspaidAdj5.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryImportspaidVat15.Text) || EntryImportspaidVat15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                }
                if (string.IsNullOrEmpty(EntryImportspaidVat5.Text) || EntryImportspaidVat5.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                }
                ...
                if (string.IsNullOrEmpty(EntryImportsaccAmt15.Text) || EntryImportsaccAmt15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryImportsaccAmt5.Text) || EntryImportsaccAmt5.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryImportsaccAdj15.Text) || EntryImportsaccAdj15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryImportsaccAdj5.Text) || EntryImportsaccAdj5.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                ...
                if (string.IsNullOrEmpty(EntryImportsaccVat15.Text) || EntryImportsaccVat15.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                }
                if (string.IsNullOrEmpty(EntryImportsaccVat5.Text) || EntryImportsaccVat5.TextColor == Colors.Red)
                {
                    IsAllEntered = false;
                }
        ...
        private void EntryVatAmountFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryVatAmount.Text) && EntryVatAmount.Text.Contains(","))
                {
                    ...
                    EntryVatAmount.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryVatAdjustmentFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryVatAdjustmentWithSAR.Text) && EntryVatAdjustmentWithSAR.Text.Contains(","))
                {
                    ...
                    EntryVatAdjustmentWithSAR.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntrySalesGccAmtFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntrySalesGccAmt.Text) && EntrySalesGccAmt.Text.Contains(","))
                {
                    ...
                    EntrySalesGccAmt.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntrySalesGccAdjFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntrySalesGccAdj.Text) && EntrySalesGccAdj.Text.Contains(","))
                {
                    ...
                    EntrySalesGccAdj.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryZerosalesAmtFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryZerosalesAmt.Text) && EntryZerosalesAmt.Text.Contains(","))
                {
                    ...
                    EntryZerosalesAmt.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryZerosalesAdjFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryZerosalesAdj.Text) && EntryZerosalesAdj.Text.Contains(","))
                {
                    ...
                    EntryZerosalesAdj.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryExportsAmtFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryExportsAmt.Text) && EntryExportsAmt.Text.Contains(","))
                {
                    ...
                    EntryExportsAmt.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryExportsAdjFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryExportsAdj.Text) && EntryExportsAdj.Text.Contains(","))
                {
                    ...
                    EntryExportsAdj.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryExemptsalesAmtFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryExemptsalesAmt.Text) && EntryExemptsalesAmt.Text.Contains(","))
                {
                    ...
                    EntryExemptsalesAmt.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryStdpurchaseAmtFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryStdpurchaseAmt.Text) && EntryStdpurchaseAmt.Text.Contains(","))
                {
                    ...
                    EntryStdpurchaseAmt.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryStdpurchaseAdjFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryStdpurchaseAdj.Text) && EntryStdpurchaseAdj.Text.Contains(","))
                {
                    ...
                    EntryStdpurchaseAdj.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryZVatAmountWithSARFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryZVatAmountWithSAR.Text) && EntryZVatAmountWithSAR.Text.Contains(","))
                {
                    ...
                    EntryZVatAmountWithSAR.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryImportspaidAdjFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryImportspaidAdj.Text) && EntryImportspaidAdj.Text.Contains(","))
                {
                    ...
                    EntryImportspaidAdj.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryImportsaccAmtFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryImportsaccAmt.Text) && EntryImportsaccAmt.Text.Contains(","))
                {
                    ...
                    EntryImportsaccAmt.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryImportsaccAdjFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryImportsaccAdj.Text) && EntryImportsaccAdj.Text.Contains(","))
                {
                    ...
                    EntryImportsaccAdj.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryZeropurchaseAmtFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryZeropurchaseAmt.Text) && EntryZeropurchaseAmt.Text.Contains(","))
                {
                    ...
                    EntryZeropurchaseAmt.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryZeropurchaseAdjFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryZeropurchaseAdj.Text) && EntryZeropurchaseAdj.Text.Contains(","))
                {
                    ...
                    EntryZeropurchaseAdj.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryExemptpurchaseAmtFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryExemptpurchaseAmt.Text) && EntryExemptpurchaseAmt.Text.Contains(","))
                {
                    ...
                    EntryExemptpurchaseAmt.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryExemptpurchaseAdjFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryExemptpurchaseAdj.Text) && EntryExemptpurchaseAdj.Text.Contains(","))
                {
                    ...
                    EntryExemptpurchaseAdj.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryPreperiodcorrFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryPreperiodcorr.Text) && EntryPreperiodcorr.Text.Contains(","))
                {
                    ...
                    EntryPreperiodcorr.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryVatAdjustmentWithSAR_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryVatAdjustmentWithSAR.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryZerosalesAmt_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryZerosalesAmt.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryZerosalesAdj_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryZerosalesAdj.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryExemptsalesAdj_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryExemptsalesAdj.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryStdpurchaseAmt_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryStdpurchaseAmt.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryStdpurchaseAdj_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryStdpurchaseAdj.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryZVatAmountWithSAR_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryZVatAmountWithSAR.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryImportsaccAmt_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryImportsaccAmt.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryImportsaccAdj_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryImportsaccAdj.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryZeropurchaseAmt_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryZeropurchaseAmt.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryZeropurchaseAdj_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryZeropurchaseAdj.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryExemptpurchaseAmt_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryExemptpurchaseAmt.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryExemptpurchaseAdj_Unfocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (ElevenDotTwoDecimalPlacesAndNoNegativeValue.iSValiedNumber)
                {
                    ...
                    EntryExemptpurchaseAdj.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
                else
                {
                    viewModel.IsUnFocusedTextBox = true;
        ...
        private void EntryVatAmount15Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryVatAmount15.Text) && EntryVatAmount15.Text.Contains(","))
                {
                    ...
                    EntryVatAmount15.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryVatAdjustment15Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryVatAdjustmentWithSAR15.Text) && EntryVatAdjustmentWithSAR15.Text.Contains(","))
                {
                    ...
                    EntryVatAdjustmentWithSAR15.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void ClickGestureRecognizer_ClickedForVatGovrenmentAmount(object sender, TextChangedEventArgs e)
        {
            try
            {
                bool isArabicChecked = true;
        ...
        private void EntryVatAmount5Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryVatAmount5.Text) && EntryVatAmount5.Text.Contains(","))
                {
                    ...
                    EntryVatAmount5.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryVatSalesSubjecttoTaxAmountFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryVatSalesTaxAmount.Text) && EntryVatSalesTaxAmount.Text.Contains(","))
                {
                    ...
                    EntryVatSalesTaxAmount.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryVatAdjustment5Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryVatAdjustmentWithSAR5.Text) && EntryVatAdjustmentWithSAR5.Text.Contains(","))
                {
                    ...
                    EntryVatAdjustmentWithSAR5.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryVatSalesSubjectToTaxAdjustmentFocused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryVatSalesTaxAdjustmentWithSAR.Text) && EntryVatSalesTaxAdjustmentWithSAR.Text.Contains(","))
                {
                    ...
                    EntryVatSalesTaxAdjustmentWithSAR.TextColor = (Color)Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryStdpurchaseAmt15Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryStdpurchaseAmt15.Text) && EntryStdpurchaseAmt15.Text.Contains(","))
                {
                    ...
                    EntryStdpurchaseAmt15.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryStdpurchaseAdj15Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryStdpurchaseAdj15.Text) && EntryStdpurchaseAdj15.Text.Contains(","))
                {
                    ...
                    EntryStdpurchaseAdj15.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryStdpurchaseAmt5Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryStdpurchaseAmt5.Text) && EntryStdpurchaseAmt5.Text.Contains(","))
                {
                    ...
                    EntryStdpurchaseAmt5.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryStdpurchaseAdj5Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryStdpurchaseAdj5.Text) && EntryStdpurchaseAdj5.Text.Contains(","))
                {
                    ...
                    EntryStdpurchaseAdj5.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryZVatAmountWithSAR15Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryZVatAmountWithSAR15.Text) && EntryZVatAmountWithSAR15.Text.Contains(","))
                {
                    ...
                    EntryZVatAmountWithSAR15.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryImportspaidAdj15Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryImportspaidAdj15.Text) && EntryImportspaidAdj15.Text.Contains(","))
                {
                    ...
                    EntryImportspaidAdj15.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryZVatAmountWithSAR5Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryZVatAmountWithSAR5.Text) && EntryZVatAmountWithSAR5.Text.Contains(","))
                {
                    ...
                    EntryZVatAmountWithSAR5.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryImportspaidAdj5Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryImportspaidAdj5.Text) && EntryImportspaidAdj5.Text.Contains(","))
                {
                    ...
                    EntryImportspaidAdj5.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryImportsaccAmt15Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryImportsaccAmt15.Text) && EntryImportsaccAmt15.Text.Contains(","))
                {
                    ...
                    EntryImportsaccAmt15.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryImportsaccAdj15Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryImportsaccAdj15.Text) && EntryImportsaccAdj15.Text.Contains(","))
                {
                    ...
                    EntryImportsaccAdj15.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryImportsaccAmt5Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryImportsaccAmt5.Text) && EntryImportsaccAmt5.Text.Contains(","))
                {
                    ...
                    EntryImportsaccAmt5.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        private void EntryImportsaccAdj5Focused(object sender, FocusEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(EntryImportsaccAdj5.Text) && EntryImportsaccAdj5.Text.Contains(","))
                {
                    ...
                    EntryImportsaccAdj5.TextColor = (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]; ;
                }
            }
            catch (Exception)
            {
        ...
        public async Task OnConfirmAndCarryForwardClicked()
        {
                        ...
                        if (viewModel.IsDeclarationCheckedForSummary && (viewModel.IsVoidClicked == false && viewModel.IsResetClicked == false))
                        {
                            if ((App.ICRStatus == "E0045" || App.ICRStatus == "E0006") && viewModel.IsAmendClicked == true || (App.ICRStatus == "E0001" || viewModel.IsCheckedDraftMode()))
                            {
                                if (viewModel.IsRefundNoMsgDisplayed == false)
                                {
                                    ...
                                    {
                                        await OnConfirmAndCarryForwardClicked();
        ...
        private async Task submitTheApplication()
        {
            viewModel.IsNewLoading = true;
            await viewModel.SubmitClicked();
            viewModel.IsNewLoading = false;
