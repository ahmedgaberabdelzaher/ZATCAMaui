...
public partial class ZakatExemptionPageView : ContentPage
{
	...
	public async void LoadData()
	{
		...
		if (_zakatExemptionModel == null || _zakatExemptionModel.d == null)
		{
		...
		else
		{
			...
			if (_zakatExemptionModel.d.TinName == "" || _zakatExemptionModel.d.TinName == null)
			{
				TPNAME.Text = " -- ";
			}
			else
			...
			if (_zakatExemptionModel.d.Actnm == "" || _zakatExemptionModel.d.Actnm == null)
			{
				TPACTY.Text = "";
			}
			else
			...
			if (_zakatExemptionModel.d.Tin == "" || _zakatExemptionModel.d.Tin == null)
			{
				TPTIN.Text = "";
			}
			else
			...
			if (_zakatExemptionModel.d.Mobile == "" || _zakatExemptionModel.d.Mobile == null)
			{
				TPMN.Text = "";
			}
			else
			...
			if (_zakatExemptionModel.d.Email == "" || _zakatExemptionModel.d.Email == null)
			{
				TPEA.Text = " -- ";
			}
			else
			...
			if (_zakatExemptionModel.d.CrNumber == "" || _zakatExemptionModel.d.CrNumber == null)
			{
				TPCN.Text = " -- ";
			}
			else
			...
			if (_zakatExemptionModel.d.CommDate == null)
			{
				TPCNDATE.Text = " -- ";
			}
			else
