...
namespace ZATCAMAUI.Core.CustomControls.SyncFusionEnabledControls
{
    ...
    public class SignUpTitle : Grid
    {
        ...
        public SignUpTitle()
        {
            ...
            this.Add(LeadingView, 1, 0);
            this.Add(Content, 2, 0);
            this.Add(TrailingView, 3, 0);
            this.Add(boxView, 0, 1);
            this.SetColumnSpan(boxView, 5);
        }
        #endregion
        ...
        private static void OnTitlePropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            if (!string.IsNullOrEmpty(newText))
            {
                ...
                titleView.Add(titleView.titleLabel, 2, 0);
            }
        }
        /// <summary>
