...
namespace ZATCAMAUI.Core.Helper
{
    public static class ZATCAConstants
    {
        ...
        public static string PaymentDevBaseUrlForODataServices = ZATCAConstants.BaseUrlOfODataServices;
        public static string PaymentQABaseUrlForODataServices = ZATCAConstants.BaseUrlOfODataServices;
        public static string UatBaseUrlForODataServices = ZATCAConstants.BaseUrlOfODataServices;
        public static string PreProdBaseUrlForODataServices = ZATCAConstants.BaseUrlOfODataServices;
        public static string ProdBaseUrlForODataServices = ZATCAConstants.BaseUrlOfODataServices;
        #region Cookie Info
